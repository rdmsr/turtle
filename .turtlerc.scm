...
(define-public failed-prompt (string-concatenate (list (colorize-string "%u " 'BLUE 'BOLD) (colorize-string "%d " 'CYAN 'BOLD) (colorize-string "λ " 'RED 'BOLD) (color 'RESET)))) ;; red lambda
